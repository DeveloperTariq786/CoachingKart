...
const InstituteList: React.FC<InstituteListProps> = ({ institutions, isLoading, isLoadingMore }) => {
    ...
    if (institutions.length === 0) {
        return (
            <div className="flex flex-col items-center justify-center py-12 md:py-20 text-center bg-white border border-slate-100 rounded-xl md:rounded-2xl shadow-sm px-4">
                ...
                <h3 className="text-base md:text-lg font-bold text-slate-800 mb-1">No Institutions Found</h3>
                <p className="text-xs md:text-sm text-slate-500 max-w-sm">We couldn't find any institutions matching your selection. Try adjusting your filters.</p>
            </div>
        );
    }
