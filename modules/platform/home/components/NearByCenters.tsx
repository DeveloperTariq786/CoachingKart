...
const NearByCenters: React.FC = () => {
    ...
    return (
        <section ref={sectionRef} className="py-8 md:py-16 bg-slate-50">
            <div className="w-full px-4 sm:px-6 lg:px-10">

                <div className="flex flex-col items-center justify-center text-center mb-6 md:mb-12">
                    <div className="max-w-2xl">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 tracking-tight">Nearby Coachings</h2>
                ...
                {locationDenied && (
                    <div className="mb-6 md:mb-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 rounded-xl border border-primary-100 bg-primary-50/50 p-3.5 sm:px-5 sm:py-3">
                        ...
                        <Button
                            ...
                            size="sm"
                            className="w-full sm:w-auto shrink-0 rounded-lg bg-primary-600 hover:bg-primary-700 text-white font-semibold px-4 cursor-pointer text-xs sm:text-sm h-9"
                        >
                            Allow Location
                        </Button>
                    </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3.5 sm:gap-4 md:gap-4">
                    ...
                    {showFallback && (
                        <div className="col-span-1 sm:col-span-2 md:col-span-3 lg:col-span-5 py-8 md:py-12 px-4 text-center bg-white rounded-xl md:rounded-2xl border border-slate-100 flex flex-col items-center justify-center">
                            <p className="text-slate-500 font-medium pb-2 text-base md:text-lg">No nearby coachings found right now.</p>
                            <p className="text-slate-400 text-xs sm:text-sm">We are expanding our network, please check back later or try exploring other areas.</p>
                        </div>
                    )}
                </div>
