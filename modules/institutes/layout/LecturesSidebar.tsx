...
const LecturesSidebar: React.FC = () => {
    ...
    return (
        <aside className="hidden lg:flex w-64 flex-col bg-white border-r border-slate-100/80 fixed top-14 h-[calc(100vh-56px)] overflow-y-auto shadow-[1px_0_10px_rgba(0,0,0,0.02)]">
            {/* Navigation */}
